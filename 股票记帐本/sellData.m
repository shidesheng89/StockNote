...
//  股票记帐本
//
//  Created by 施德胜 on 15/9/9.
//  Copyright (c) 2015年 施德胜. All rights reserved.
//

#import "sellData.h"

@implementation sellData
...
- (void)saveData{
    ...
    [archiver encodeObject:_sellData forKey:@"data"];//_局部变量，self属性
...
- (void) loadData{
    ...
    if ([[NSFileManager defaultManager]fileExistsAtPath:path]) {
        ...
        self.sellData=[unarchiver decodeObjectForKey:@"data"];
